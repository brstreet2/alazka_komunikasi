        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group @if($errors->has('image')) has-error @endif">
                    <label for="image" class="control-label">Image (Max 12MB) <span style="color: red">*</span></label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" accept=".png,.jpeg,.jpg" name="image" id="image"/>
            ...
            <div class="col-md-12">
                <div class="form-group @if($errors->has('publish')) has-error @endif">
                    ...
                    <select name="publish" id="publish" class="form-control text-light input-sm select_2" style="width: 100%;" data-placeholder="Select..*" required>
                        <option></option>
